...
export const QUESTIONS = [
  ...
  },
  {
    ...
    eyebrow: "Daily pace",
    noPref: true,
    title: "How full do you want your days?",
    options: [
      { key: "relaxed", label: "Relaxed", value: "Relaxed", description: "A couple of things a day, plenty of downtime" },
      { key: "balanced", label: "Balanced", value: "Balanced", description: "A few planned things, room to wander" },
      { key: "fast-paced", label: "Fast-paced", value: "Fast-paced", description: "Full days, see as much as you can" },
      { key: "no-pref", label: "No preference", value: "No preference", noPref: true },
    ],
  },
  {
    ...
    field: "activity",
    type: "single",
    eyebrow: "Physical activity",
    noPref: true,
    title: "How physically active do you want to be?",
    options: [
      { key: "light", label: "Light", value: "Light", description: "Mostly walking, cafés and museums" },
      { key: "moderate", label: "Moderate", value: "Moderate", description: "Some hiking or cycling, a few active hours" },
      { key: "active", label: "Active", value: "Active", description: "Regular hiking, real effort most days" },
      { key: "very", label: "Very active", value: "Highly active", description: "Hiking, watersports, physically demanding days" },
      { key: "no-pref", label: "No preference", value: "No preference", noPref: true },
    ],
  },
];
